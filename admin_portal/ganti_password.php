<?php
 ...
 $title='Dashboard';
   ...
   $Password=$_POST['Password'];
    ...
    $sql1=$db->query($sql);    
    if($sql1->num_rows<=0)
     {  //update data pada database dari ubah password
       $sel="UPDATE admin_login SET Adm_Password='".$Password."' where ID='".$USER_ID."'";
       $info=$db->query($sel);
         if($info){ //penambahan alert jika sudah selesai ubah password
