      ...
      <div class="card mb-3">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
          <div class="row">
            ...
            <label for="exampleInputEmail1">Masukan Menu </label>
         ...
         <div class="form-group col-lg-4">
            ...
            <select class="form-control" name="Menu_Type"  id="Menu_Type" required="">
                <option  hidden="">Pilih Tipe Menu </option>
                <option value="STUDENT">Murid</option>
                <option value="MAZEDAR">Mahasiswa</option>
                <option value="ECONOMY">Ekonomi</option>

            </select>
          </div>
          <div class="form-group col-lg-4">
            <label for="exampleInputEmail1">Masukan Nama Menu </label>
